...
gem 'sparql', git: 'https://github.com/ruby-rdf/sparql', branch: 'develop', require: false
gem 'sparql-client', git: 'https://github.com/ruby-rdf/sparql-client', branch: 'develop', require: false
