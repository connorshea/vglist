...
export interface Game {
  ...
  mobygamesId?: Maybe<Scalars['String']['output']>;
  /** Name of the game. */
  name: Scalars['String']['output'];
...
export interface MutationCreateGameArgs {
  ...
  mobygamesId?: InputMaybe<Scalars['String']['input']>;
  name: Scalars['String']['input'];
...
export type AddGameToLibraryMutation = { addGameToLibrary?: { gamePurchase?: { id: string, game: { id: string, name: string } } | null } | null };
...
export type UpdateGameInLibraryMutation = { updateGameInLibrary?: { gamePurchase?: { id: string, completionStatus?: GamePurchaseCompletionStatus | null, rating?: number | null, hoursPlayed?: number | null, comments?: string | null } | null } | null };
...
export type GameFieldsFragment = { id: string, name: string, releaseDate?: string | null, avgRating?: number | null, coverUrl?: string | null, developers: { nodes: Array<{ id: string, name: string }> }, publishers: { nodes: Array<{ id: string, name: string }> }, platforms: { nodes: Array<{ id: string, name: string }> }, genres: { nodes: Array<{ id: string, name: string }> }, engines: { nodes: Array<{ id: string, name: string }> }, series?: { id: string, name: string } | null };
...
export type GetGameQuery = { game?: { wikidataId?: number | null, steamAppIds: Array<number>, pcgamingwikiId?: string | null, mobygamesId?: string | null, giantbombId?: string | null, epicGamesStoreId?: string | null, gogId?: string | null, igdbId?: string | null, id: string, name: string, releaseDate?: string | null, avgRating?: number | null, coverUrl?: string | null, developers: { nodes: Array<{ id: string, name: string }> }, publishers: { nodes: Array<{ id: string, name: string }> }, platforms: { nodes: Array<{ id: string, name: string }> }, genres: { nodes: Array<{ id: string, name: string }> }, engines: { nodes: Array<{ id: string, name: string }> }, series?: { id: string, name: string } | null } | null };
...
export type GetGamesQuery = { games?: { nodes: Array<{ id: string, name: string, releaseDate?: string | null, coverUrl?: string | null, developers: { nodes: Array<{ id: string, name: string }> } }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };
...
export type GetRecentGamesQuery = { games?: { nodes: Array<{ id: string, name: string, coverUrl?: string | null, platforms: { nodes: Array<{ id: string, name: string }> }, developers: { nodes: Array<{ id: string, name: string }> } }> } | null };
...
export type SearchGamesQuery = { gameSearch?: { nodes: Array<{ id: string, name: string, releaseDate?: string | null, coverUrl?: string | null, developers: { nodes: Array<{ id: string, name: string }> } }> } | null };
...
export type GetPlatformsQuery = { platforms?: { nodes: Array<{ id: string, name: string }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };
...
export type GetPlatformQuery = { platform?: { id: string, name: string, wikidataId?: number | null, games: { nodes: Array<{ id: string, name: string, coverUrl?: string | null }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } } | null };
...
export type GetCompaniesQuery = { companies?: { nodes: Array<{ id: string, name: string }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };
...
export type GetCompanyQuery = { company?: { id: string, name: string, wikidataId?: number | null, developedGames: { nodes: Array<{ id: string, name: string, coverUrl?: string | null }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } }, publishedGames: { nodes: Array<{ id: string, name: string, coverUrl?: string | null }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } } | null };
...
export type GetGenresQuery = { genres?: { nodes: Array<{ id: string, name: string }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };
...
export type GetGenreQuery = { genre?: { id: string, name: string, wikidataId?: number | null, games: { nodes: Array<{ id: string, name: string, coverUrl?: string | null }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } } | null };
...
export type GetEnginesQuery = { engines?: { nodes: Array<{ id: string, name: string }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };
...
export type GetEngineQuery = { engine?: { id: string, name: string, wikidataId?: number | null, games: { nodes: Array<{ id: string, name: string, coverUrl?: string | null }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } } | null };
...
export type GetSeriesListQuery = { seriesList?: { nodes: Array<{ id: string, name: string }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };
...
export type GetSeriesQuery = { series?: { id: string, name: string, wikidataId?: number | null, games: { nodes: Array<{ id: string, name: string, coverUrl?: string | null }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } } | null };
...
export type GetStoresQuery = { stores?: { nodes: Array<{ id: string, name: string }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };
...
export type GlobalSearchQuery = { globalSearch: { nodes: Array<
      | { searchableId: string, searchableType: SearchableEnum, content: string }
      | { searchableId: string, searchableType: SearchableEnum, content: string }
      | { searchableId: string, searchableType: SearchableEnum, content: string, coverUrl?: string | null, developerName?: string | null, releaseDate?: string | null }
      | { searchableId: string, searchableType: SearchableEnum, content: string }
      | { searchableId: string, searchableType: SearchableEnum, content: string }
      | { searchableId: string, searchableType: SearchableEnum, content: string }
      | { searchableId: string, searchableType: SearchableEnum, content: string, avatarUrl?: string | null, slug: string }
    > } };
...
export type GetActivityQuery = { activity?: { nodes: Array<{ id: string, eventCategory: EventCategory, createdAt: string, user: { id: string, username: string, slug: string, avatarUrl?: string | null } }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };

export type GetBasicSiteStatisticsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBasicSiteStatisticsQuery = { basicSiteStatistics: { games: number, platforms: number, series: number, engines: number, companies: number, genres: number } };

export type GetCurrentUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentUserQuery = { currentUser?: { id: string, username: string, bio?: string | null, slug: string, role: UserRole, privacy: UserPrivacy, avatarUrl?: string | null, hideDaysPlayed: boolean } | null };
...
export type GetUserQuery = { user?: { id: string, username: string, bio?: string | null, slug: string, role: UserRole, privacy: UserPrivacy, createdAt: string, banned: boolean, avatarUrl?: string | null, isFollowed?: boolean | null, hideDaysPlayed: boolean, gamePurchases: { nodes: Array<{ id: string, hoursPlayed?: number | null, completionStatus?: GamePurchaseCompletionStatus | null, rating?: number | null, game: { id: string, name: string, coverUrl?: string | null } }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } }, followers: { totalCount: number, nodes: Array<{ id: string, username: string, slug: string, avatarUrl?: string | null }> }, following: { totalCount: number, nodes: Array<{ id: string, username: string, slug: string, avatarUrl?: string | null }> }, favoritedGames: { nodes: Array<{ id: string, name: string, coverUrl?: string | null }> } } | null };
...
export type GetUsersQuery = { users?: { nodes: Array<{ id: string, username: string, slug: string, avatarUrl?: string | null, gamePurchases: { totalCount: number } }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } | null };

export type GetCurrentUserProfileQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentUserProfileQuery = { currentUser?: { id: string, bio?: string | null, privacy: UserPrivacy, hideDaysPlayed: boolean } | null };
...
export type SearchUsersQuery = { userSearch?: { nodes: Array<{ id: string, username: string, slug: string, avatarUrl?: string | null }> } | null };
