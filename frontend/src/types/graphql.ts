...
export interface Mutation {
  ...
  /**
   * Update the current user's email address. Requires current password for
   * verification. The new email must be confirmed before it takes effect.
   */
...
export type DeleteUserMutation = { deleteUser?: { deleted: boolean } | null };

export type ResetUserLibraryMutationVariables = Exact<{
  userId: Scalars["ID"]["input"];
}>;

export type ResetUserLibraryMutation = { resetUserLibrary?: { deleted: boolean } | null };
...
export type UpdateEmailMutation = { updateEmail?: { errors: Array<string>; user?: { id: string } | null } | null };
