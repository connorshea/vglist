...
ALTER TABLE ONLY public.events_favorite_game_events
    ADD CONSTRAINT fk_rails_31a149f860 FOREIGN KEY (eventable_id) REFERENCES public.favorite_games(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.events_game_purchase_events
    ADD CONSTRAINT fk_rails_54d9eb6aa1 FOREIGN KEY (eventable_id) REFERENCES public.game_purchases(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.events_user_events
    ADD CONSTRAINT fk_rails_d08547655e FOREIGN KEY (eventable_id) REFERENCES public.users(id) ON DELETE CASCADE;
