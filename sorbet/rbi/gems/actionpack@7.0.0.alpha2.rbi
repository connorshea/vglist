...
class ActionController::Base < ::ActionController::Metal
  ...
  def responder=(_arg0); end
  def responder?; end
  def silence_disabled_session_errors; end
  def silence_disabled_session_errors=(value); end
...
module ActionController::QueryTags
  extend ::ActiveSupport::Concern

  private

  def expose_controller_to_query_logs(&block); end
end
...
module ActionController::Redirecting
  ...
  def _compute_safe_redirect_to_location(request, options, response_options); end
...
module ActionController::RequestForgeryProtection
  ...
  def ensure_session_is_enabled!; end
...
class ActionController::RequestForgeryProtection::DisabledSessionError < ::StandardError
  def initialize(message = T.unsafe(nil)); end
end

ActionController::RequestForgeryProtection::DisabledSessionError::MESSAGE = T.let(T.unsafe(nil), String)
