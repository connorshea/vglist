...
class ActionView::Helpers::CacheHelper::CachingRegistry
...
module ActionView::Helpers::FormOptionsHelper
  ...
  def weekday_options_for_select(selected = T.unsafe(nil), index_as_value: T.unsafe(nil), day_format: T.unsafe(nil)); end
