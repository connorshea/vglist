...
class GraphQL::Execution::Interpreter::Runtime
  ...
  def evaluate_selection_with_args(kwarg_arguments, field_defn, next_path, ast_node, field_ast_nodes, scoped_context, owner_type, object, is_eager_field, result_name, selection_result, parent_object); end
...
class GraphQL::Schema::Directive::Deprecated < ::GraphQL::Schema::Directive; end
...
class GraphQL::Schema::Validator::NumericalityValidator < ::GraphQL::Schema::Validator
  def initialize(greater_than: T.unsafe(nil), greater_than_or_equal_to: T.unsafe(nil), less_than: T.unsafe(nil), less_than_or_equal_to: T.unsafe(nil), equal_to: T.unsafe(nil), other_than: T.unsafe(nil), odd: T.unsafe(nil), even: T.unsafe(nil), within: T.unsafe(nil), message: T.unsafe(nil), **default_options); end
...
class GraphQL::StaticValidation::Validator
  ...
  def validate(query, validate: T.unsafe(nil), timeout: T.unsafe(nil)); end
end
...
class GraphQL::Subscriptions::Event
  ...
  class << self
    def serialize(_name, arguments, field, scope:); end
