...
class Faraday::RequestOptions < Anonymous_Faraday_Options_30
  def []=(key, value); end
end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_31
  def disable?; end
  def verify?; end
end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_32
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_33
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_34
  def [](key); end
  def []=(key, value); end
  def clear_body; end
...
class Faraday::Request < Anonymous_Struct_35
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
