...
class ActiveModel::AttributeMethods::ClassMethods::CodeGenerator::MethodSet
...
ActiveModel::AttributeMethods::ClassMethods::CodeGenerator::MethodSet::METHOD_CACHES = T.let(T.unsafe(nil), Hash)
