...
RuboCop::AST::NodePattern::Sets::SET_BLANK_EMPTY = T.let(T.unsafe(nil), Set)
...
RuboCop::AST::NodePattern::Sets::SET_CHANGE_COLUMN_EXECUTE_REMOVE_BELONGS_TO_REMOVE_REFERENCE = T.let(T.unsafe(nil), Set)
