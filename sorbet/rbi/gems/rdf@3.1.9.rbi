...
class RDF::Util::Logger::IOWrapper
  ...
  def append_cflags(*args, &block); end
  def append_cppflags(*args, &block); end
  def append_ldflags(*args, &block); end
  def append_library(*args, &block); end
  def arg_config(*args, &block); end
  ...
  def cpp_command(*args, &block); end
  def cpp_include(*args, &block); end
  def create_header(*args, &block); end
  def create_makefile(*args, &block); end
  ...
  def depend_rules(*args, &block); end
  def detect(*args, &block); end
  def dir_config(*args, &block); end
  def drop(*args, &block); end
  def drop_while(*args, &block); end
  def dummy_makefile(*args, &block); end
  def duplicable?(*args, &block); end
  def each(*args, &block); end
  def each_byte(*args, &block); end
  def each_char(*args, &block); end
  def each_codepoint(*args, &block); end
  def each_compile_rules(*args, &block); end
  ...
  def echo?(*args, &block); end
  def egrep_cpp(*args, &block); end
  def enable_config(*args, &block); end
  ...
  def find_executable0(*args, &block); end
  def find_header(*args, &block); end
  def find_index(*args, &block); end
  def find_library(*args, &block); end
  def find_type(*args, &block); end
  ...
  def have_const(*args, &block); end
  def have_devel?(*args, &block); end
  def have_framework(*args, &block); end
  def have_func(*args, &block); end
  def have_header(*args, &block); end
  def have_library(*args, &block); end
  def have_macro(*args, &block); end
  def have_struct_member(*args, &block); end
  def have_type(*args, &block); end
  def have_typeof?(*args, &block); end
  def have_var(*args, &block); end
  ...
  def init_mkmf(*args, &block); end
  def inject(*args, &block); end
  def install_dirs(*args, &block); end
  def install_files(*args, &block); end
  def install_rb(*args, &block); end
  ...
  def libpath_env(*args, &block); end
  def libpathflag(*args, &block); end
  ...
  def map_dir(*args, &block); end
  def max(*args, &block); end
  def max_by(*args, &block); end
  def member?(*args, &block); end
  def merge_libs(*args, &block); end
  def message(*args, &block); end
  def min(*args, &block); end
  def min_by(*args, &block); end
  def minmax(*args, &block); end
  def minmax_by(*args, &block); end
  def mkintpath(*args, &block); end
  def mkmf_failed(*args, &block); end
  def modified?(*args, &block); end
  ...
  def relative_from(*args, &block); end
  ...
  def try_compile(*args, &block); end
  def try_const(*args, &block); end
  def try_constant(*args, &block); end
  def try_cpp(*args, &block); end
  def try_cppflags(*args, &block); end
  def try_do(*args, &block); end
  def try_func(*args, &block); end
  def try_header(*args, &block); end
  def try_ldflags(*args, &block); end
  def try_link(*args, &block); end
  def try_link0(*args, &block); end
  def try_run(*args, &block); end
  def try_signedness(*args, &block); end
  def try_static_assert(*args, &block); end
  def try_type(*args, &block); end
  def try_var(*args, &block); end
  def tty?(*args, &block); end
  def typedef_expr(*args, &block); end
  ...
  def what_type?(*args, &block); end
  def winsep(*args, &block); end
  def winsize(*args, &block); end
  def winsize=(*args, &block); end
  def with_cflags(*args, &block); end
  def with_config(*args, &block); end
  def with_cppflags(*args, &block); end
  def with_destdir(*args, &block); end
  def with_ldflags(*args, &block); end
  def with_options(*args, &block); end
  def with_werror(*args, &block); end
  def without(*args, &block); end
  def write(*args, &block); end
  def write_nonblock(*args, &block); end
  def xpopen(*args, &block); end
  def xsystem(*args, &block); end
...
class RDF::Vocabulary::Format < ::RDF::Format
end
