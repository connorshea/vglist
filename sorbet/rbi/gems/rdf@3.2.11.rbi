...
class RDF::Util::Logger::IOWrapper
  ...
  def <=>(*args, **_arg1, &block); end
  def __binding__(*args, **_arg1, &block); end
  def __getobj__; end
  ...
  def byebug(*args, **_arg1, &block); end
  ...
  def remote_byebug(*args, **_arg1, &block); end
  ...
  def should(*args, **_arg1, &block); end
  def should_not(*args, **_arg1, &block); end
  ...
  def to_sxp(*args, **_arg1, &block); end
