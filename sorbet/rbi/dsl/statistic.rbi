...
class Statistic
  ...
  module CommonRelationMethods
    ...
    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Statistic).void)).returns(::Statistic) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Statistic, T::Enumerable[T.any(::Statistic, T::Enumerable[::Statistic])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Statistic, Integer, String, T::Enumerable[T.any(::Statistic, Integer, String, T::Enumerable[::Statistic])])).returns(T::Array[::Statistic]) }
    ...
    sig { params(other_array: T.any(::Statistic, T::Enumerable[T.any(::Statistic, T::Enumerable[::Statistic])])).returns(T::Array[::Statistic]) }
