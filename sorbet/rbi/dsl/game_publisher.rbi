...
class GamePublisher
  ...
  module CommonRelationMethods
    ...
    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::GamePublisher).void)).returns(::GamePublisher) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::GamePublisher, T::Enumerable[T.any(::GamePublisher, T::Enumerable[::GamePublisher])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::GamePublisher, Integer, String, T::Enumerable[T.any(::GamePublisher, Integer, String, T::Enumerable[::GamePublisher])])).returns(T::Array[::GamePublisher]) }
    ...
    sig { params(other_array: T.any(::GamePublisher, T::Enumerable[T.any(::GamePublisher, T::Enumerable[::GamePublisher])])).returns(T::Array[::GamePublisher]) }
