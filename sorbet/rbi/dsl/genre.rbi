...
class Genre
  ...
  class << self
    sig { params(args: T.untyped).returns(Genre::PrivateRelation) }
    def search(*args); end
  end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Genre, T::Enumerable[T.any(::Genre, T::Enumerable[::Genre])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Genre, Integer, String, T::Enumerable[T.any(::Genre, Integer, String, T::Enumerable[::Genre])])).returns(T::Array[::Genre]) }
    ...
    sig { params(other_array: T.any(::Genre, T::Enumerable[T.any(::Genre, T::Enumerable[::Genre])])).returns(T::Array[::Genre]) }
