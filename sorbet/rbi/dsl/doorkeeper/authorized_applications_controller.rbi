...
# This is an autogenerated file for dynamic methods in `Doorkeeper::AuthorizedApplicationsController`.
# Please instead update this file by running `bin/tapioca dsl Doorkeeper::AuthorizedApplicationsController`.
