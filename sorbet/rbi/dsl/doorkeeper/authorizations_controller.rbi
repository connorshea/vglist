...
# This is an autogenerated file for dynamic methods in `Doorkeeper::AuthorizationsController`.
# Please instead update this file by running `bin/tapioca dsl Doorkeeper::AuthorizationsController`.
