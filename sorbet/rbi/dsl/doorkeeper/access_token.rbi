...
class Doorkeeper::AccessToken
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Doorkeeper::AccessToken).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Doorkeeper::AccessToken).void)).returns(::Doorkeeper::AccessToken) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Doorkeeper::AccessToken, T::Enumerable[T.any(::Doorkeeper::AccessToken, T::Enumerable[::Doorkeeper::AccessToken])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Doorkeeper::AccessToken, Integer, String, T::Enumerable[T.any(::Doorkeeper::AccessToken, Integer, String, T::Enumerable[::Doorkeeper::AccessToken])])).returns(T::Array[::Doorkeeper::AccessToken]) }
    ...
    sig { params(other_array: T.any(::Doorkeeper::AccessToken, T::Enumerable[T.any(::Doorkeeper::AccessToken, T::Enumerable[::Doorkeeper::AccessToken])])).returns(T::Array[::Doorkeeper::AccessToken]) }
