...
class Versions::EngineVersion
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Versions::EngineVersion).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Versions::EngineVersion).void)).returns(::Versions::EngineVersion) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Versions::EngineVersion, T::Enumerable[T.any(::Versions::EngineVersion, T::Enumerable[::Versions::EngineVersion])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Versions::EngineVersion, Integer, String, T::Enumerable[T.any(::Versions::EngineVersion, Integer, String, T::Enumerable[::Versions::EngineVersion])])).returns(T::Array[::Versions::EngineVersion]) }
    ...
    sig { params(other_array: T.any(::Versions::EngineVersion, T::Enumerable[T.any(::Versions::EngineVersion, T::Enumerable[::Versions::EngineVersion])])).returns(T::Array[::Versions::EngineVersion]) }
