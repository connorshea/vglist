...
class Versions::GenreVersion
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Versions::GenreVersion).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Versions::GenreVersion).void)).returns(::Versions::GenreVersion) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Versions::GenreVersion, T::Enumerable[T.any(::Versions::GenreVersion, T::Enumerable[::Versions::GenreVersion])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Versions::GenreVersion, Integer, String, T::Enumerable[T.any(::Versions::GenreVersion, Integer, String, T::Enumerable[::Versions::GenreVersion])])).returns(T::Array[::Versions::GenreVersion]) }
    ...
    sig { params(other_array: T.any(::Versions::GenreVersion, T::Enumerable[T.any(::Versions::GenreVersion, T::Enumerable[::Versions::GenreVersion])])).returns(T::Array[::Versions::GenreVersion]) }
