...
class Versions::GameVersion
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Versions::GameVersion).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Versions::GameVersion).void)).returns(::Versions::GameVersion) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Versions::GameVersion, T::Enumerable[T.any(::Versions::GameVersion, T::Enumerable[::Versions::GameVersion])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Versions::GameVersion, Integer, String, T::Enumerable[T.any(::Versions::GameVersion, Integer, String, T::Enumerable[::Versions::GameVersion])])).returns(T::Array[::Versions::GameVersion]) }
    ...
    sig { params(other_array: T.any(::Versions::GameVersion, T::Enumerable[T.any(::Versions::GameVersion, T::Enumerable[::Versions::GameVersion])])).returns(T::Array[::Versions::GameVersion]) }
