...
class Versions::PlatformVersion
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Versions::PlatformVersion).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Versions::PlatformVersion).void)).returns(::Versions::PlatformVersion) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Versions::PlatformVersion, T::Enumerable[T.any(::Versions::PlatformVersion, T::Enumerable[::Versions::PlatformVersion])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Versions::PlatformVersion, Integer, String, T::Enumerable[T.any(::Versions::PlatformVersion, Integer, String, T::Enumerable[::Versions::PlatformVersion])])).returns(T::Array[::Versions::PlatformVersion]) }
    ...
    sig { params(other_array: T.any(::Versions::PlatformVersion, T::Enumerable[T.any(::Versions::PlatformVersion, T::Enumerable[::Versions::PlatformVersion])])).returns(T::Array[::Versions::PlatformVersion]) }
