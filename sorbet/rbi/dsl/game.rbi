...
class Game
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::Game, T::Enumerable[T.any(::Game, T::Enumerable[::Game])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::Game, Integer, String, T::Enumerable[T.any(::Game, Integer, String, T::Enumerable[::Game])])).returns(T::Array[::Game]) }
    ...
    sig { params(other_array: T.any(::Game, T::Enumerable[T.any(::Game, T::Enumerable[::Game])])).returns(T::Array[::Game]) }
