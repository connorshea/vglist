...
# This is an autogenerated file for dynamic methods in `Oauth::AuthorizationsController`.
# Please instead update this file by running `bin/tapioca dsl Oauth::AuthorizationsController`.
