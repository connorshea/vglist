...
# This is an autogenerated file for dynamic methods in `Oauth::ApplicationsController`.
# Please instead update this file by running `bin/tapioca dsl Oauth::ApplicationsController`.
