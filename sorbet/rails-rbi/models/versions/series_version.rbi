...
# Please rerun bundle exec rake rails_rbi:models[Versions::SeriesVersion] to regenerate.

# typed: strong
module Versions::SeriesVersion::ActiveRelation_WhereNot
  sig { params(opts: T.untyped, rest: T.untyped).returns(T.self_type) }
  def not(opts, *rest); end
end

module Versions::SeriesVersion::CustomFinderMethods
  sig { params(limit: Integer).returns(T::Array[Versions::SeriesVersion]) }
  def first_n(limit); end

  sig { params(limit: Integer).returns(T::Array[Versions::SeriesVersion]) }
  def last_n(limit); end

  sig { params(args: T::Array[T.any(Integer, String)]).returns(T::Array[Versions::SeriesVersion]) }
  def find_n(*args); end

  sig { params(id: T.nilable(Integer)).returns(T.nilable(Versions::SeriesVersion)) }
  def find_by_id(id); end

  sig { params(id: Integer).returns(Versions::SeriesVersion) }
  def find_by_id!(id); end
end

class Versions::SeriesVersion < PaperTrail::Version
  include Versions::SeriesVersion::GeneratedAttributeMethods
  include Versions::SeriesVersion::GeneratedAssociationMethods
  extend Versions::SeriesVersion::CustomFinderMethods
  extend Versions::SeriesVersion::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(Versions::SeriesVersion::ActiveRecord_Relation, Versions::SeriesVersion::ActiveRecord_Associations_CollectionProxy, Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  ...
  sig { params(num: T.nilable(Integer)).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def self.page(num = nil); end

  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def self.per(num, max_per_page = nil); end

  sig { params(num: Integer).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
...
module Versions::SeriesVersion::QueryMethodsReturningRelation
  sig { returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def all; end

  sig { params(block: T.nilable(T.proc.void)).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  ...
  sig { params(block: T.proc.params(e: Versions::SeriesVersion).returns(T::Boolean)).returns(T::Array[Versions::SeriesVersion]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def in_order_of(column, values); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  ...
  sig do
    params(
      ...
      block: T.nilable(T.proc.params(e: Versions::SeriesVersion::ActiveRecord_Relation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end

module Versions::SeriesVersion::QueryMethodsReturningAssociationRelation
  sig { returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def all; end

  sig { params(block: T.nilable(T.proc.void)).returns(Versions::SeriesVersion::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def reselect(*args); end
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def extending(*args, &block); end
  ...
  sig do
    params(
      ...
      load: T.nilable(T::Boolean),
      error_on_ignore: T.nilable(T::Boolean),
      block: T.nilable(T.proc.params(e: Versions::SeriesVersion::ActiveRecord_AssociationRelation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end

class Versions::SeriesVersion::ActiveRecord_Relation < ActiveRecord::Relation
  include Versions::SeriesVersion::ActiveRelation_WhereNot
  include Versions::SeriesVersion::CustomFinderMethods
  include Versions::SeriesVersion::QueryMethodsReturningRelation
...
class Versions::SeriesVersion::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  include Versions::SeriesVersion::ActiveRelation_WhereNot
  include Versions::SeriesVersion::CustomFinderMethods
  include Versions::SeriesVersion::QueryMethodsReturningAssociationRelation
  Elem = type_member {{fixed: Versions::SeriesVersion}}

  sig { params(num: T.nilable(Integer)).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def page(num = nil); end

  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def per(num, max_per_page = nil); end

  sig { params(num: Integer).returns(Versions::SeriesVersion::ActiveRecord_AssociationRelation) }
  def padding(num); end
...
module Versions::SeriesVersion::GeneratedAttributeMethods
...
module Versions::SeriesVersion::GeneratedAssociationMethods
...
class Versions::SeriesVersion::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  include Versions::SeriesVersion::CustomFinderMethods
  include Versions::SeriesVersion::QueryMethodsReturningAssociationRelation
  Elem = type_member {{fixed: Versions::SeriesVersion}}

  sig { params(records: T.any(Versions::SeriesVersion, T::Array[Versions::SeriesVersion])).returns(T.self_type) }
  def <<(*records); end
