...
module Versions::EngineVersion::QueryMethodsReturningRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Versions::EngineVersion::ActiveRecord_Relation) }
...
module Versions::EngineVersion::QueryMethodsReturningAssociationRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Versions::EngineVersion::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
