# This is an autogenerated file for dynamic methods in Versions::GameVersion
# Please rerun bundle exec rake rails_rbi:models[Versions::GameVersion] to regenerate.

# typed: strong
module Versions::GameVersion::ActiveRelation_WhereNot
  sig { params(opts: T.untyped, rest: T.untyped).returns(T.self_type) }
  def not(opts, *rest); end
end

module Versions::GameVersion::CustomFinderMethods
  sig { params(limit: Integer).returns(T::Array[Versions::GameVersion]) }
  def first_n(limit); end

  sig { params(limit: Integer).returns(T::Array[Versions::GameVersion]) }
  def last_n(limit); end

  sig { params(args: T::Array[T.any(Integer, String)]).returns(T::Array[Versions::GameVersion]) }
  def find_n(*args); end

  sig { params(id: T.nilable(Integer)).returns(T.nilable(Versions::GameVersion)) }
  def find_by_id(id); end

  sig { params(id: Integer).returns(Versions::GameVersion) }
  def find_by_id!(id); end
end

class Versions::GameVersion < PaperTrail::Version
  include Versions::GameVersion::GeneratedAttributeMethods
  include Versions::GameVersion::GeneratedAssociationMethods
  extend Versions::GameVersion::CustomFinderMethods
  extend Versions::GameVersion::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(Versions::GameVersion::ActiveRecord_Relation, Versions::GameVersion::ActiveRecord_Associations_CollectionProxy, Versions::GameVersion::ActiveRecord_AssociationRelation) }
  ...
  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(Versions::GameVersion::ActiveRecord_Relation) }
...
module Versions::GameVersion::QueryMethodsReturningRelation
  sig { returns(Versions::GameVersion::ActiveRecord_Relation) }
  def all; end

  sig { params(block: T.nilable(T.proc.void)).returns(Versions::GameVersion::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped).returns(Versions::GameVersion::ActiveRecord_Relation) }
  ...
  sig { params(block: T.proc.params(e: Versions::GameVersion).returns(T::Boolean)).returns(T::Array[Versions::GameVersion]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Versions::GameVersion::ActiveRecord_Relation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(Versions::GameVersion::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Versions::GameVersion::ActiveRecord_Relation) }
  def in_order_of(column, values); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(Versions::GameVersion::ActiveRecord_Relation) }
  ...
  sig do
    params(
      ...
      block: T.nilable(T.proc.params(e: Versions::GameVersion::ActiveRecord_Relation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end

module Versions::GameVersion::QueryMethodsReturningAssociationRelation
  sig { returns(Versions::GameVersion::ActiveRecord_AssociationRelation) }
  def all; end

  sig { params(block: T.nilable(T.proc.void)).returns(Versions::GameVersion::ActiveRecord_Relation) }
  def unscoped(&block); end

  sig { params(args: T.untyped).returns(Versions::GameVersion::ActiveRecord_AssociationRelation) }
  def reselect(*args); end
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Versions::GameVersion::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(Versions::GameVersion::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Versions::GameVersion::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.void)).returns(Versions::GameVersion::ActiveRecord_AssociationRelation) }
  def extending(*args, &block); end
  ...
  sig do
    params(
      ...
      load: T.nilable(T::Boolean),
      error_on_ignore: T.nilable(T::Boolean),
      block: T.nilable(T.proc.params(e: Versions::GameVersion::ActiveRecord_AssociationRelation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end

class Versions::GameVersion::ActiveRecord_Relation < ActiveRecord::Relation
...
class Versions::GameVersion::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(Versions::GameVersion::ActiveRecord_AssociationRelation) }
  def per(num, max_per_page = nil); end
...
module Versions::GameVersion::GeneratedAssociationMethods
