...
class ActiveStorage::Record < ActiveRecord::Base
  ...
  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(ActiveStorage::Record::ActiveRecord_Relation) }
...
class ActiveStorage::Record::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(ActiveStorage::Record::ActiveRecord_AssociationRelation) }
  def per(num, max_per_page = nil); end
