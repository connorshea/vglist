...
module SteamBlocklist::QueryMethodsReturningRelation
  ...
  sig { params(args: Symbol).returns(SteamBlocklist::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(SteamBlocklist::ActiveRecord_Relation) }
...
module SteamBlocklist::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: Symbol).returns(SteamBlocklist::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(SteamBlocklist::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
