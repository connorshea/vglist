...
module Statistic::QueryMethodsReturningRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Statistic::ActiveRecord_Relation) }
...
module Statistic::QueryMethodsReturningAssociationRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Statistic::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
