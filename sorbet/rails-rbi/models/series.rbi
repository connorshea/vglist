...
module Series::QueryMethodsReturningRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Series::ActiveRecord_Relation) }
...
module Series::QueryMethodsReturningAssociationRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Series::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
