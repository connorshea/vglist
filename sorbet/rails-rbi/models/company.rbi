...
# Please rerun bundle exec rake rails_rbi:models[Company] to regenerate.
...
module Company::CustomFinderMethods
  ...
  sig { params(id: T.nilable(Integer)).returns(T.nilable(Company)) }
...
class Company < ApplicationRecord
  ...
  extend Company::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(Company::ActiveRecord_Relation, Company::ActiveRecord_Associations_CollectionProxy, Company::ActiveRecord_AssociationRelation) }
...
module Company::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: Company).returns(T::Boolean)).returns(T::Array[Company]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Company::ActiveRecord_Relation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(Company::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Company::ActiveRecord_Relation) }
...
module Company::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Company::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(Company::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Company::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
