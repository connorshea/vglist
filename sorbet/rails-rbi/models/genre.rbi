...
# Please rerun bundle exec rake rails_rbi:models[Genre] to regenerate.
...
module Genre::CustomFinderMethods
  ...
  sig { params(id: T.nilable(Integer)).returns(T.nilable(Genre)) }
...
class Genre < ApplicationRecord
  ...
  extend Genre::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(Genre::ActiveRecord_Relation, Genre::ActiveRecord_Associations_CollectionProxy, Genre::ActiveRecord_AssociationRelation) }
...
module Genre::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: Genre).returns(T::Boolean)).returns(T::Array[Genre]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Genre::ActiveRecord_Relation) }
...
module Genre::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Genre::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end
...
module Genre::GeneratedAssociationMethods
  ...
  sig { returns(::Versions::GenreVersion::ActiveRecord_Associations_CollectionProxy) }
  def versions; end

  sig { returns(T::Array[Integer]) }
  def version_ids; end

  sig { params(value: T::Enumerable[::Versions::GenreVersion]).void }
