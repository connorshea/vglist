...
module GamePurchasePlatform::CustomFinderMethods
  ...
  sig { params(id: T.nilable(Integer)).returns(T.nilable(GamePurchasePlatform)) }
...
module GamePurchasePlatform::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: GamePurchasePlatform).returns(T::Boolean)).returns(T::Array[GamePurchasePlatform]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GamePurchasePlatform::ActiveRecord_Relation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(GamePurchasePlatform::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GamePurchasePlatform::ActiveRecord_Relation) }
...
module GamePurchasePlatform::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GamePurchasePlatform::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(GamePurchasePlatform::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GamePurchasePlatform::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
