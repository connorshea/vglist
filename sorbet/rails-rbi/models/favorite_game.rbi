...
# Please rerun bundle exec rake rails_rbi:models[FavoriteGame] to regenerate.
...
module FavoriteGame::CustomFinderMethods
  ...
  sig { params(id: T.nilable(Integer)).returns(T.nilable(FavoriteGame)) }
...
class FavoriteGame < ApplicationRecord
  ...
  extend FavoriteGame::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(FavoriteGame::ActiveRecord_Relation, FavoriteGame::ActiveRecord_Associations_CollectionProxy, FavoriteGame::ActiveRecord_AssociationRelation) }
...
module FavoriteGame::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: FavoriteGame).returns(T::Boolean)).returns(T::Array[FavoriteGame]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(FavoriteGame::ActiveRecord_Relation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(FavoriteGame::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(FavoriteGame::ActiveRecord_Relation) }
...
module FavoriteGame::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(FavoriteGame::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(FavoriteGame::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(FavoriteGame::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
