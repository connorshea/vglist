...
module Events::UserEvent::QueryMethodsReturningRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Events::UserEvent::ActiveRecord_Relation) }
...
module Events::UserEvent::QueryMethodsReturningAssociationRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Events::UserEvent::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
