...
class Events::GamePurchaseEvent < ApplicationRecord
  ...
  include Events::GamePurchaseEvent::GeneratedAttributeMethods
  ...
  sig { returns(Events::GamePurchaseEvent::EventCategory) }
  def typed_event_category; end

  sig { params(value: Events::GamePurchaseEvent::EventCategory).void }
