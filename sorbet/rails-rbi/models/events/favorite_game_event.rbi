...
class Events::FavoriteGameEvent < ApplicationRecord
  ...
  include Events::FavoriteGameEvent::GeneratedAttributeMethods
  ...
  sig { returns(Events::FavoriteGameEvent::EventCategory) }
  def typed_event_category; end

  sig { params(value: Events::FavoriteGameEvent::EventCategory).void }
