...
module WikidataBlocklist::QueryMethodsReturningRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(WikidataBlocklist::ActiveRecord_Relation) }
...
module WikidataBlocklist::QueryMethodsReturningAssociationRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(WikidataBlocklist::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
