...
module GameEngine::QueryMethodsReturningRelation
  ...
  sig { params(args: Symbol).returns(GameEngine::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GameEngine::ActiveRecord_Relation) }
...
module GameEngine::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: Symbol).returns(GameEngine::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GameEngine::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
