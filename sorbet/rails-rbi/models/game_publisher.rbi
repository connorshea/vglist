...
module GamePublisher::CustomFinderMethods
  ...
  sig { params(id: T.nilable(Integer)).returns(T.nilable(GamePublisher)) }
...
module GamePublisher::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: GamePublisher).returns(T::Boolean)).returns(T::Array[GamePublisher]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GamePublisher::ActiveRecord_Relation) }
...
module GamePublisher::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GamePublisher::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end
