...
module Doorkeeper::Application::QueryMethodsReturningRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Doorkeeper::Application::ActiveRecord_Relation) }
...
module Doorkeeper::Application::QueryMethodsReturningAssociationRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Doorkeeper::Application::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
