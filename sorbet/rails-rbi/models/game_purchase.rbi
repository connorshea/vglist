...
module GamePurchase::QueryMethodsReturningRelation
  ...
  sig { params(args: Symbol).returns(GamePurchase::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GamePurchase::ActiveRecord_Relation) }
...
module GamePurchase::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: Symbol).returns(GamePurchase::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GamePurchase::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
