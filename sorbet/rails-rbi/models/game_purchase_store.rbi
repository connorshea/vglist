...
module GamePurchaseStore::CustomFinderMethods
  ...
  sig { params(id: T.nilable(Integer)).returns(T.nilable(GamePurchaseStore)) }
...
module GamePurchaseStore::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: GamePurchaseStore).returns(T::Boolean)).returns(T::Array[GamePurchaseStore]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GamePurchaseStore::ActiveRecord_Relation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(GamePurchaseStore::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GamePurchaseStore::ActiveRecord_Relation) }
...
module GamePurchaseStore::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(GamePurchaseStore::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end

  sig { params(args: Symbol).returns(GamePurchaseStore::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(GamePurchaseStore::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
