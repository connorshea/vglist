...
class PgSearch::Document < ActiveRecord::Base
  ...
  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(PgSearch::Document::ActiveRecord_Relation) }
...
class PgSearch::Document::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(num: Integer, max_per_page: T.nilable(Integer)).returns(PgSearch::Document::ActiveRecord_AssociationRelation) }
  def per(num, max_per_page = nil); end

  sig { params(num: Integer).returns(PgSearch::Document::ActiveRecord_AssociationRelation) }
  def padding(num); end
end
