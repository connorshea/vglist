...
module UnmatchedGame::QueryMethodsReturningRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(UnmatchedGame::ActiveRecord_Relation) }
...
module UnmatchedGame::QueryMethodsReturningAssociationRelation
  ...
  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(UnmatchedGame::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
