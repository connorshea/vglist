...
#++
# TODO: Move this to application.rb and upgrade it to SHA256 in the future.
...
#++
# TODO: Move this to application.rb, also we can remove it after upgrading from SHA1 to SHA256.
